...
def main():
    ...
    script_path = script_dir / "MESS06.DAT_jpn.json"
    ...
    # overwrite = True
    source_array = {
        "007A0=007BE": "ャャャャ|ｪワ|Mに乗るがよい。|E|3|3|4|6",
        "0080E=00834": "ンテは再びフレギュアスの舟に乗り、|N|C|1|8|8",
        "020D0=0210D": "ャャャャャャャャャャャャャャ|?ャ|Xティージュの沼を戻って行った。",
        "00AA6=00ADC": "ャャャャャャャャャ|ｺャ|tレギュアスが困っていたよ。|W|5|N|C|2|1|2",
        "02576=025B1": "ャャャャャャャ|Wャ|Aマノの代わりに合図の炎の番をする手伝い|C|2|1|3",
        "025B3=025D2": "ャ|Vモ|{さなきゃいけないってね。",
    }
    dialogue_array = {
        "007A0=007BE": "ャャャャ|ｪワ|Mに乗るがよい。|E|3|3|4|6",
        "0080C=00834": "aンテは再びフレギュアスの舟に乗り、|N|C|1|8|8",
        "020D0=0210D": "ャャャャャャャャャャャャャャ|?ャ|Xティージュの沼を戻って行った。",
        "00AA6=00ADC": "ャャャャャャャャャ|ｺャ|tレギュアスが困っていたよ。|W|5|N|C|2|1|2",
        "02576=025B1": "ャャャャャャャ|Wャ|Aマノの代わりに合図の炎の番をする手伝い|C|2|1|3",
        "025B3=025D2": "ャ|Vモ|{さなきゃいけないってね。",
