...
def main():
    ...
    input_cand.append(["나니와", "둥근모"])
    input_cand.append(["도토미", "둥근모"])
    input_cand.append(["마루네", "둥근모"])
    input_cand.append(["무사시", "둥근모"])
    input_cand.append(["미카와", "둥근모"])
    input_cand.append(["사가미", "둥근모"])
    input_cand.append(["사카이", "둥근모"])
    input_cand.append(["스루가", "둥근모"])
    input_cand.append(["시나노", "둥근모"])
    input_cand.append(["아즈치", "둥근모"])
    input_cand.append(["야마토", "둥근모"])
    input_cand.append(["오사카", "둥근모"])
    input_cand.append(["오와리", "둥근모"])
    input_cand.append(["와시즈", "둥근모"])
    input_cand.append(["와카사", "둥근모"])
    input_cand.append(["에치고", "둥근모"])
    input_cand.append(["에치젠", "둥근모"])
    input_cand.append(["이나바", "둥근모"])
    # input_cand.append(["이마이", "둥근모"])
    input_cand.append(["이와미", "둥근모"])
    input_cand.append(["이즈모", "둥근모"])
    input_cand.append(["치쿠젠", "둥근모"])
    input_cand.append(["코즈케", "둥근모"])
    input_cand.append(["키요스", "둥근모"])
    input_cand.append(["타지마", "둥근모"])
    input_cand.append(["하리마", "둥근모"])
